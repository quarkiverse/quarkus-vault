...
a| [[quarkus-vault_quarkus-vault-authentication-userpass-auth-mount-path]]`link:#quarkus-vault_quarkus-vault-authentication-userpass-auth-mount-path[quarkus.vault.authentication.userpass.auth-mount-path]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_VAULT_AUTHENTICATION_USERPASS_AUTH_MOUNT_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
